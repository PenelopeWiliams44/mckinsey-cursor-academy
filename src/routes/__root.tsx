...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cursor Compass is a user-friendly dashboard for McKinsey employees to learn and use Cursor." },
      { property: "og:description", content: "Cursor Compass is a user-friendly dashboard for McKinsey employees to learn and use Cursor." },
      { name: "twitter:description", content: "Cursor Compass is a user-friendly dashboard for McKinsey employees to learn and use Cursor." },
